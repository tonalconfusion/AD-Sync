...
write-host ("--------------------------------------------------------------------------------------------------------") -ForegroundColor Red
sleep(1)
New-variable -name CSVFile -Value  "\\enterprise\scripts\SyncADUsersCsv\Users-dev.csv" -Visibility Private
}
Else {
New-variable -name CSVFile -Value  "\\enterprise\scripts\SyncADUsersCsv\Users.csv" -Visibility Private
}
New-variable -name CSVExportFile -Value  "\\enterprise\scripts\SyncADUsersCsv\Users-Export.csv" -Visibility Private
...
New-variable -name Log  -value "\\enterprise\scripts\logs\AdSync-Log-$Today_Date-V$myVer.txt" -Visibility Private
$CompanyName = "DKPCREPAIRS"
$distinguishedName = "DC=dkpcrepairs,DC=homeip,DC=net"
$UPND = "@dkpcrepairs.homeip.net"
